...
import MetricTableCard from "./MetricTableCard";
import { approximatePercentile, dailyUrl, lifetimeUrl } from "./useStats";
import {
  compactNumber,
  exactNumber,
  milliseconds,
...
/**
 * The dashboard body. `full` adds the sections that are only on /stats-full:
 * reliability, performance and retention.
 */
export default function StatsDashboard({ full = false }) {
  return (
    <>
      <SummaryPanel />
